...
class OlivesPizza(BasePizza, IngredientsMixin):
...
class PepperoniPizza(BasePizza, IngredientsMixin):
...
class MushroomOnionBaconPizza(BasePizza, IngredientsMixin):
...
class CountryPizza(BasePizza, IngredientsMixin):
