# Подвиг 5. Подвиг 4. Вводятся данные по книге в виде строки через запятую в формате (некоторые значения могут отсутствовать):
#
...
match book:
    case [str(author), str(title)]:
        print('YES'.title())
    case [int(_), author, title]:
        print('YES'.title())
    case [int(_), author, title, price]:
        print('YES'.title())
    case [int(_), author, title, price, year]:
        print('YES'.title())
    case _:
        print('NO'.title())
...
#
# match book:
#     case ([int(), str(), str()] | [int(), str(), str(), float(), int()] |
#           [int(), str(), str(), int()] | [int(), str(), str(), float()]):
#         print("Yes")
#     case _:
#         print("No")
